...
ANA_DIR="/srv/data/Geant4/masimu-1/simtetra-main/myanalyse/PARIS50"
RUN_CMD="./run_paris.scr"

FILES_TO_MERGE=(
  "output_PARIS50_E447.337keV.root"
  "output_PARIS50_E4878.65keV.root"
  "output_PARIS50_E8887.34keV.root"
)
