...
NEVT=1000000                       # évts par job
NTHREADS=10                         # threads Geant4 par job
NJOBS=40                            # nombre total de jobs à lancer
MAX_PROCS=4                        # nb maximum de processus concurrents (à ajuster vs. tes CPU)
OUTBASE="eu152"                    # préfixe pour nommer les fichiers
